...
def web_portfolio():
   ...
   # Initialize session state for contact info visibility
    ...
    # Initialize state for skills visibility
    if 'skills_visible' not in st.session_state:
        st.session_state.skills_visible = False

    # Function to toggle skills visibility
    def toggle_skills():
        st.session_state.skills_visible = not st.session_state.skills_visible

    # Sidebar Items
    st.sidebar.markdown(
        f"""
        <div class='sidebar-item' onclick="toggle_skills()">
    ...
    # Show/hide skills based on state
    if st.session_state.skills_visible:
        st.sidebar.markdown(
            """
